  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url('${process.env.NEXT_PUBLIC_API_URL}/uploads/background-move.jpg')` }}
      >
              ...
              <div className="wow fadeInUp" data-wow-delay=".3s">
                <div className="icon-box-items">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Hỗ trợ toàn diện từ khi bắt đầu cho đến khi bạn nhận được
                      visa.
                    </p>
                  </div>
                </div>
              ...
              <div className="wow fadeInUp" data-wow-delay=".5s">
                <div className="icon-box-items active">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Tỷ lệ phê duyệt visa cao giúp bạn an tâm trong hành trình
                      của mình.
                    </p>
                  </div>
                </div>
              ...
              <div className="wow fadeInUp" data-wow-delay=".7s">
                <div className="icon-box-items h-full">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Hỗ trợ định cư ở các quốc gia phát triển và trở thành công
                      dân toàn cầu.
                    </p>
                  </div>
                </div>
