...
function AboutForm({aboutForm}:{aboutForm: AboutData }){
    ...
    return   <div className="flex flex-col justify-center gap-8 items-center p-8">
  ...
  >
    ...
    <FormItemUpload label="Large Image URL(437x530):" name="imgLarge"  value={aboutForm.imgLarge} onChange={() => {}} />
    ...
    <FormItemUpload label="Small Image URL(269x277):" name="img"  value={aboutForm.img} onChange={() => {}} />
        <FormItemUpload label="CEO Avatar URL(68x68):" name="avatarCeo"  value={aboutForm.avatarCeo} onChange={() => {}} />


    <FormItem label="Title" name="title" type="text" placeholder="Ex: Về Chúng Tôi" value={aboutForm.title} onChange={() => {}} />

    <FormItem label="Description" name="description" type="text" placeholder="Type description here" value={aboutForm.description} onChange={() => {}} />
