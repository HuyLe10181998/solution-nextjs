...
function FormItemUpload({ value, onChange, name,label,id = 1 }: FormItemUploadProps){
    ...
    return <div className="mb-4 w-full items-center md:flex md:gap-0 gap-4">
          <label 
          ...
          <div className="flex w-full gap-2 md:w-[77%] items-center">
            ...
            <Input onChange={onChange} name={name} className="!text-primary-text w-full" value={imageUrl} readOnly type="text" placeholder="https://placehold.co/315x340" />
            <label 
