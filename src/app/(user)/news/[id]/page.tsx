                                ...
                                <div className="single-blog-post post-details mt-0">
                                    <div className="post-content !pt-0">
                                        ...
                                        <div className="post-meta mt-3 flex items-center gap-2">
                                            <span className="!flex items-center gap-2"><UserIcon />{post?.data?.author}</span>
                                            <span className="!flex items-center gap-2"><CalendarIcon />{formatDate(post?.data?.date)}</span>
                                        </div>
                                        <div dangerouslySetInnerHTML={{__html: post?.data?.content}} className="w-full blog-content">
                                ...
                                <div className="single-sidebar-widget">
                                    ...
                                    <div className="popular-posts">
                                        <div className="single-post-item">
                                            <div className="thumb bg-cover" style={{backgroundImage: "url('assets/img/news/pp1.jpg')"}}></div>
                                            <div className="post-content">
                                                <h5><a href="news-details.html">Visa Application Fee Increases From July 2024</a></h5>
                                                <div className="post-date">24th March 2024</div>
                                            </div>
                                        </div>
