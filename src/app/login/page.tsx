  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24">
        ...
        <h2 className="text-2xl text-gray-700 mb-8">Sign in</h2>
      ...
      <div
        ...
        className="hidden bg-no-repeat object-cover lg:block bg-center lg:w-1/2 bg-gradient-to-br from-blue-500 to-blue-600"
      ></div>
    </div>
  )
}
